...
\end{verbatim}
\paragraph{Phân tích}
Hàm heuristic này đủ tốt để vượt qua cả bài test khó (`tricky`), với số nút mở rộng thấp hơn nhiều so với ngưỡng yêu cầu. Việc sử dụng `mazeDistance` và cache lại kết quả là chìa khóa thành công.
